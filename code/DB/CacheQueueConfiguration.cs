...
namespace Foundation.HtmlCache.DB
{
    ...
    public class CacheQueueConfiguration : EntityTypeConfiguration<CacheQueue>
    {
        ...
        public CacheQueueConfiguration(string schema)
        {
            ...
            Property(x => x.Site).HasColumnName(@"Site").HasColumnType("varchar").IsOptional().IsUnicode(false).HasMaxLength(250);
            Property(x => x.Language).HasColumnName(@"Language").HasColumnType("varchar").IsOptional().IsUnicode(false).HasMaxLength(250);
