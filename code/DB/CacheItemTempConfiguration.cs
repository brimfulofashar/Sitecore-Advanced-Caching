...
namespace Foundation.HtmlCache.DB
{
    ...
    public class CacheItemTempConfiguration : EntityTypeConfiguration<CacheItemTemp>
    {
        ...
        public CacheItemTempConfiguration(string schema)
        {
            ...
            // Foreign keys
            HasOptional(a => a.CacheKeyTemp).WithMany(b => b.CacheItemTemps).HasForeignKey(c => c.CacheKeyId).WillCascadeOnDelete(false); // FK_CacheItemTemp_CacheKeyTemp
            HasRequired(a => a.CacheQueue).WithMany(b => b.CacheItemTemps).HasForeignKey(c => c.CacheQueueId); // FK_CacheItemTemp_CacheQueue
        }
    }
